...
for (const critical of ['Policy Gate - Validate Constraints', 'Fetch Repository Metadata',
...
// Safe mock traversal using the exact execution-1887 batch. No network node
...
const payload = {
  ...
  requestId: '9b62e087-02a8-409d-bfb1-a951629a8814', attemptCount: 1,
