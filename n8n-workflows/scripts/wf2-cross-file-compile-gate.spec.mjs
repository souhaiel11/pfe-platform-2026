...
assert.equal(wf.connections['Validate Cross-File Candidate Manifest'].main[0][0].node,'Validate Cross-File Type Coherence');
assert.equal(wf.connections['Validate Cross-File Type Coherence'].main[0][0].node,'Prepare Cross-File COMPILE_MAIN');
