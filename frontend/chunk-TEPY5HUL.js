...
var DashboardComponent = class _DashboardComponent {
  ...
  loadData() {
    this.api.getGlobalStats().subscribe((s) => this.stats = s);
    this.api.getProjects().subscribe((p) => this.projects = p);
    this.api.getAgentStats().subscribe((a) => {
      this.agentStats = [
        { name: "Root Cause", icon: "\u25C8", color: "#38bdf8", score: a.rootCause || 92, count: a.rcaCount || 0 },
        { name: "Security Risk", icon: "\u2B21", color: "#e24b4a", score: a.security || 88, count: a.secCount || 0 },
        { name: "Remediation", icon: "\u25C6", color: "#22c55e", score: a.remediation || 85, count: a.remCount || 0 },
        { name: "Judge Agent", icon: "\u25A3", color: "#f59e0b", score: a.judge || 96, count: a.judgeCount || 0 }
      ];
    });
  }
...
//# sourceMappingURL=chunk-TEPY5HUL.js.map
