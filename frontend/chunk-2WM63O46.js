...
var LoginComponent = class _LoginComponent {
  ...
  login() {
    ...
    this.auth.login(this.username, this.password).subscribe({
      next: () => {
        this.toast.success("Connexion r\xE9ussie", `Bienvenue ${this.username}`);
        this.router.navigate(["/dashboard"]);
      },
      error: (err) => {
        this.loading = false;
        this.error = err.status === 401 ? "Identifiants incorrects." : "Erreur de connexion au serveur.";
      }
    });
  }
  static {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LoginComponent, selectors: [["app-login"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 32, vars: 7, consts: [[1, "login-shell"], [1, "login-left"], [1, "brand"], [1, "brand-icon"], [1, "brand-name"], [1, "brand-sub"], [1, "feature-list"], ["class", "feature", 4, "ngFor", "ngForOf"], [1, "brand-footer"], [1, "login-right"], [1, "login-card"], [1, "login-header"], [1, "login-title"], [1, "login-sub"], [1, "form-group"], [1, "form-label"], ["placeholder", "admin", 1, "form-control", 3, "ngModelChange", "keydown.enter", "ngModel"], ["type", "password", "placeholder", "\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022", 1, "form-control", 3, "ngModelChange", "keydown.enter", "ngModel"], [1, "btn", "btn-primary", 2, "width", "100%", "justify-content", "center", "padding", "10px", 3, "click", "disabled"], ["class", "spinner", "style", "width:14px;height:14px;border-width:1.5px;", 4, "ngIf"], [4, "ngIf"], ["class", "login-error", 4, "ngIf"], [1, "feature"], [1, "feature-icon"], [1, "feature-title"], [1, "feature-desc"], [1, "spinner", 2, "width", "14px", "height", "14px", "border-width", "1.5px"], [1, "login-error"]], template: function LoginComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LoginComponent, { className: "LoginComponent", filePath: "src/app/features/auth/login.component.ts", lineNumber: 187 });
})();
export {
  LoginComponent
};
//# sourceMappingURL=chunk-2WM63O46.js.map
