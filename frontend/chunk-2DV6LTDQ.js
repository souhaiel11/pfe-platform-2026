...
function AnalysisComponent_div_9_div_2_div_73_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 31)(1, "div", 28);
    \u0275\u0275text(2, "\u{1F4DD} RAISON DE LA D\xC9CISION");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(r_r5.p == null ? null : r_r5.p.reason);
  }
}
function AnalysisComponent_div_9_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(50, "Niveau s\xE9curit\xE9");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(51, "span");
    \u0275\u0275text(52);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(53, "div", 31)(54, "div", 28);
    \u0275\u0275text(55, "\u274C ERREURS D\xC9TECT\xC9ES");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(56, "div", 32);
    \u0275\u0275text(57);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(58, "div", 31)(59, "div", 28);
    \u0275\u0275text(60, "\u{1F916} CE QUE LES AGENTS IA ONT FAIT");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(61, "div", 32);
    \u0275\u0275text(62);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(63, "div", 33)(64, "div", 28);
    \u0275\u0275text(65, "\u{1F468}\u200D\u{1F4BB} CE QUE LE D\xC9VELOPPEUR DOIT FAIRE");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(66, "div", 34);
    \u0275\u0275text(67);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(68, "div", 31)(69, "div", 28);
    \u0275\u0275text(70, "\u{1F4A1} RECOMMANDATIONS");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(71, "div", 32);
    \u0275\u0275text(72);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(73, AnalysisComponent_div_9_div_2_div_73_Template, 5, 1, "div", 35);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(74, "div", 36)(75, "span", 37);
    \u0275\u0275text(76);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(77, "button", 38);
    \u0275\u0275listener("click", function AnalysisComponent_div_9_div_2_Template_button_click_77_listener() {
      const r_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.copyReport(r_r5));
    });
    \u0275\u0275text(78, "\u{1F4CB} Copier");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2(" ", \u0275\u0275pipeBind2(10, 27, r_r5.createdAt, "dd/MM/yyyy HH:mm"), " \xA0\xB7\xA0 ", r_r5.project == null ? null : r_r5.project.name, " ");
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(4);
    \u0275\u0275styleProp("color", ctx_r2.getSecurityColor(r_r5.p == null ? null : r_r5.p.security));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate((r_r5.p == null ? null : r_r5.p.security) || "N/A");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((r_r5.p == null ? null : r_r5.p.errors) || "Non disponible");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((r_r5.p == null ? null : r_r5.p.agentActions) || "Non disponible");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((r_r5.p == null ? null : r_r5.p.developerActions) || "Non disponible");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((r_r5.p == null ? null : r_r5.p.recommendations) || "Non disponible");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", r_r5.p == null ? null : r_r5.p.reason);
    \u0275\u0275advance(3);
...
function AnalysisComponent_div_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, AnalysisComponent_div_9_div_1_Template, 7, 0, "div", 11)(2, AnalysisComponent_div_9_div_2_Template, 79, 30, "div", 12);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function AnalysisComponent_div_10_tr_18_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "td")(7, "div", 45)(8, "div", 46);
    \u0275\u0275element(9, "div");
    \u0275\u0275elementEnd();
...
function AnalysisComponent_div_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div")(1, "div", 39)(2, "table", 40)(3, "thead")(4, "tr")(5, "th");
    \u0275\u0275text(6, "Incident");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "th");
    \u0275\u0275text(8, "Action");
    ...
    \u0275\u0275template(17, AnalysisComponent_div_10_tr_17_Template, 3, 0, "tr", 7)(18, AnalysisComponent_div_10_tr_18_Template, 21, 20, "tr", 41);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function AnalysisComponent_div_11_div_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 54)(1, "div", 15);
...
function AnalysisComponent_div_11_div_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div", 59)(7, "span", 60);
    \u0275\u0275text(8);
    \u0275\u0275pipe(9, "date");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(9, 8, r_r7.createdAt, "dd/MM/yyyy HH:mm"));
  }
}
function AnalysisComponent_div_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div")(1, "div", 51);
    \u0275\u0275template(2, AnalysisComponent_div_11_div_2_Template, 3, 0, "div", 52)(3, AnalysisComponent_div_11_div_3_Template, 10, 11, "div", 53);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
