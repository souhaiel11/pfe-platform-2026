...
var routes = [
  {
    path: "login",
    loadComponent: () => import("./chunk-2LKHZZS2.js").then((m) => m.LoginComponent)
  },
  {
    path: "",
    canActivate: [authGuard],
    loadComponent: () => import("./chunk-SPDWOSKU.js").then((m) => m.LayoutComponent),
    children: [
      { path: "", redirectTo: "dashboard", pathMatch: "full" },
      {
        path: "dashboard",
        loadComponent: () => import("./chunk-FKCQIORZ.js").then((m) => m.DashboardComponent)
      },
      {
        path: "projects",
        loadComponent: () => import("./chunk-LA56NBYC.js").then((m) => m.ProjectsComponent)
      },
      {
        path: "projects/:id",
        loadComponent: () => import("./chunk-D7FZ5646.js").then((m) => m.ProjectDetailComponent)
      },
      {
        path: "incidents",
        loadComponent: () => import("./chunk-DNN2MUKL.js").then((m) => m.IncidentsComponent)
      },
      {
        path: "incidents/:id",
        loadComponent: () => import("./chunk-7PMJTQBW.js").then((m) => m.IncidentDetailComponent)
      },
      {
        path: "analysis",
        loadComponent: () => import("./chunk-OFYMYRKU.js").then((m) => m.AnalysisComponent)
      },
      {
        path: "notifications",
        loadComponent: () => import("./chunk-5GRUQCOL.js").then((m) => m.NotificationsComponent)
      },
      {
        path: "admin",
        loadComponent: () => import("./chunk-VHRIRV73.js").then((m) => m.AdminComponent)
      },
      {
        path: "settings",
        loadComponent: () => import("./chunk-RBEFSSN5.js").then((m) => m.SettingsComponent)
      }
    ]
  },
  { path: "**", redirectTo: "" }
...
var jwtInterceptor = (req, next) => {
  ...
  const cloned = token && !isPublic ? req.clone({ setHeaders: { Authorization: `Bearer ${token}` } }) : req;
...
function ToastComponent_div_1_span_3_Template(rf, ctx) {
  if (rf & 1) {
...
function ToastComponent_div_1_span_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, "\u2715");
    \u0275\u0275elementEnd();
...
function ToastComponent_div_1_span_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, "\u26A0");
    \u0275\u0275elementEnd();
...
function ToastComponent_div_1_span_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, "\u2139");
    \u0275\u0275elementEnd();
...
function ToastComponent_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(3, ToastComponent_div_1_span_3_Template, 2, 0, "span", 5)(4, ToastComponent_div_1_span_4_Template, 2, 0, "span", 5)(5, ToastComponent_div_1_span_5_Template, 2, 0, "span", 5)(6, ToastComponent_div_1_span_6_Template, 2, 0, "span", 6);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "div")(8, "div", 7);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
    \u0275\u0275template(10, ToastComponent_div_1_div_10_Template, 2, 1, "div", 8);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
var ToastComponent = class _ToastComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ToastComponent, selectors: [["app-toast"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 3, vars: 3, consts: [[1, "toast-container"], [3, "class", "click", 4, "ngFor", "ngForOf"], [3, "click"], [1, "toast-icon"], [3, "ngSwitch"], [4, "ngSwitchCase"], [4, "ngSwitchDefault"], [2, "font-weight", "500", "font-size", "13px"], ["style", "font-size:11px;opacity:0.8;margin-top:2px;", 4, "ngIf"], [2, "font-size", "11px", "opacity", "0.8", "margin-top", "2px"]], template: function ToastComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0);
        \u0275\u0275template(1, ToastComponent_div_1_Template, 11, 9, "div", 1);
        \u0275\u0275pipe(2, "async");
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
    ...
    }, dependencies: [CommonModule, NgForOf, NgIf, NgSwitch, NgSwitchCase, NgSwitchDefault, AsyncPipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ToastComponent, { className: "ToastComponent", filePath: "src/app/shared/toast/toast.component.ts", lineNumber: 30 });
})();
...
var AppComponent = class _AppComponent {
  ...
  static {
    ...
    }, dependencies: [RouterModule, RouterOutlet, ToastComponent], encapsulation: 2 });
  }
};
(() => {
